...
from gym.envs.robot_locomotion_group.pymunk.carrot.carrot_rewards import image_transform, lyapunov
...
class CarrotEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.action_space = spaces.Box(low=-0.4, high=0.4, shape=(4,), dtype=np.float32)
        self.observation_space = spaces.Box(low=0, high=255, shape=(32, 32), dtype=np.float32)
